...
public enum NMSVersion {
    ...
    private static NMSVersion getCurrentVersion() {
        try {
            ...
            System.out.println("[MCWrappers] Detected NMS Version: " + version);
            return valueOf(version);
        } catch (Exception e) {
            System.out.println("[MCWrappers] NMS Version incompatible with this version of StarCore, is it up to date?");
